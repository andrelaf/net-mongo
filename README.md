...
| **Anti-padrões** | array ilimitado + limite de 16MB (medido em BSON) · **Subset Pattern** · índices desnecessários (custo de escrita medido) · **Bucket Pattern** (séries temporais) |
...
> (explain, operadores atômicos). A seção **Anti-padrões** cobre os 6 erros de modelagem
> documentados pelo MongoDB (arrays maciços, coleções/índices em excesso, documentos
> inchados, separar dados acessados juntos, buscas sem collation) e os padrões de
> correção — cada página traz uma explicação **em linguagem simples com analogia** do
> dia a dia. Ref.: <https://www.mongodb.com/pt-br/docs/manual/data-modeling/design-antipatterns/>
